...
func _physics_process(delta):
	...
	var mesh_front = get_node("../Body").global_transform.basis.z
	...
	if $mouse_control_stay_delay.is_stopped():
		#FOLLOW CAMERA
		$h.rotation.y = lerp_angle($h.rotation.y, get_node("../Body").global_transform.basis.get_euler().y, delta * auto_rotate_speed)
